...
struct qt_meta_stringdata_LogcatModel_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LogcatModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LogcatModel_t qt_meta_stringdata_LogcatModel = {
    {
QT_MOC_LITERAL(0, 0, 11) // "LogcatModel"
...
const QMetaObject LogcatModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_LogcatModel.data,
      qt_meta_data_LogcatModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LogcatModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LogcatModel.stringdata0))
