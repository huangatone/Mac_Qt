...
QT_MOC_LITERAL(1, 15, 4), // "copy"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4) // "list"

    },
    "FileTableModel\0copy\0\0list"
};
...
void FileTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FileTableModel::*_t)(QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileTableModel::copy)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FileTableModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_FileTableModel.data,
      qt_meta_data_FileTableModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
struct qt_meta_stringdata_FileSortModel_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FileSortModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FileSortModel_t qt_meta_stringdata_FileSortModel = {
    {
QT_MOC_LITERAL(0, 0, 13) // "FileSortModel"
...
const QMetaObject FileSortModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_FileSortModel.data,
      qt_meta_data_FileSortModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_FileSortModel.stringdata0))
