...
struct qt_meta_stringdata_AppTableModel_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AppTableModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AppTableModel_t qt_meta_stringdata_AppTableModel = {
    {
QT_MOC_LITERAL(0, 0, 13) // "AppTableModel"
...
const QMetaObject AppTableModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_AppTableModel.data,
      qt_meta_data_AppTableModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AppTableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AppTableModel.stringdata0))
...
struct qt_meta_stringdata_AppSortModel_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AppSortModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AppSortModel_t qt_meta_stringdata_AppSortModel = {
    {
QT_MOC_LITERAL(0, 0, 12) // "AppSortModel"
...
const QMetaObject AppSortModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_AppSortModel.data,
      qt_meta_data_AppSortModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_AppSortModel.stringdata0))
